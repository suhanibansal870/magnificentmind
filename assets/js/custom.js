...
function SendMail() {
	...
	var nameboy = document.getElementById("name").value;
	var emaily = document.getElementById("email").value;
	var button = document.getElementById("form-submit");
    
    // Create a new 'a' element to construct the mailto link
    var mailtoLink = document.createElement("a");
    mailtoLink.href = "mailto:magnificentmind1@gmail.com?subject=" + encodeURIComponent(subjectLine) + "&body=" + "My name is " + nameboy+ ". My email is " + emaily + ". "+ encodeURIComponent(body);
